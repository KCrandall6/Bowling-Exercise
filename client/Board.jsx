      ...
      <div className='Container'>
        <table id='table' className='Scorecard' cellPadding='1' cellSpacing='0'>
          <tbody>
            ...
            <tr>
              <td id='cumulative-score-f1' colSpan='6'>{game.cumulativeScores[0]}</td>
              <td id='cumulative-score-f2' colSpan='6'>{game.cumulativeScores[1]}</td>
              <td id='cumulative-score-f3' colSpan='6'>{game.cumulativeScores[2]}</td>
              <td id='cumulative-score-f4' colSpan='6'>{game.cumulativeScores[3]}</td>
              <td id='cumulative-score-f5' colSpan='6'>{game.cumulativeScores[4]}</td>
              <td id='cumulative-score-f6' colSpan='6'>{game.cumulativeScores[5]}</td>
              <td id='cumulative-score-f7' colSpan='6'>{game.cumulativeScores[6]}</td>
              <td id='cumulative-score-f8' colSpan='6'>{game.cumulativeScores[7]}</td>
              <td id='cumulative-score-f9' colSpan='6'>{game.cumulativeScores[8]}</td>
              <td id='cumulative-score-f10' colSpan='6'>{game.cumulativeScores[9]}</td>
